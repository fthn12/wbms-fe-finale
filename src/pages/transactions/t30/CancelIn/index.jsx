...
const TransactionT30WbInCancel = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await transactionAPI.eDispatchT30WbInCancelAfter(data);
  ...
  useEffect(() => {
    ...
    if (values.returnWeighInKg >= WBMS.WB_MIN_WEIGHT) {
      cSubmit = true;
    }
...
export default TransactionT30WbInCancel;
