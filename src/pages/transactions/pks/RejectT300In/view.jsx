...
const TransactionPksRejectT300In = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // const response = await transactionAPI.eDispatchPksWbInRejectT300After(data);
...
export default TransactionPksRejectT300In;
