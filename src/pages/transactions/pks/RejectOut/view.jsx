...
const TransactionPksRejectOut = (props) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // const response = await transactionAPI.eDispatchPksWbOutRejectAfter(data);
        ...
        <Grid container spacing={1}>
          <Grid item xs={3} sm={6}>
            ...
            <TextField
              ...
              label="SEGEL MAINHOLE 1 WB-OUT"
              name="returnUnloadedSeal1"
              disabled={isSubmitted}
              value={values?.returnUnloadedSeal1 || ""}
            ...
            <TextField
              ...
              fullWidth
              sx={{ mt: 2, backgroundColor: isSubmitted ? "whitesmoke" : "white" }}
              label="SEGEL VALVE 1 WB-OUT"
              name="returnUnloadedSeal2"
              disabled={isSubmitted}
              value={values?.returnUnloadedSeal2 || ""}
              onChange={handleInputChange}
            />
            <TextField
              variant="outlined"
              ...
              fullWidth
              sx={{ mt: 2, backgroundColor: isSubmitted ? "whitesmoke" : "white" }}
              label="SEGEL MAINHOLE 2 WB-OUT"
              name="returnUnloadedSeal3"
              disabled={isSubmitted}
              value={values?.returnUnloadedSeal3 || ""}
              onChange={handleInputChange}
            />
            <TextField
              variant="outlined"
              ...
              fullWidth
              sx={{ mt: 2, backgroundColor: isSubmitted ? "whitesmoke" : "white" }}
              label="SEGEL VALVE 2 WB-OUT"
              name="returnUnloadedSeal4"
              disabled={isSubmitted}
              value={values?.returnUnloadedSeal4 || ""}
              onChange={handleInputChange}
            />
          </Grid>
...
export default TransactionPksRejectOut;
